...
Title: "Organizational Structure Code System"
Description: "Organizational structure of medical institutions"
* ^url = "https://terminology.dhp.uz/fhir/core/CodeSystem/organizational-structure-cs"
* ^status = #draft
* ^experimental = true
* ^caseSensitive = true
