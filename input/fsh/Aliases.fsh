...
Alias: $loinc-vs = http://hl7.org/fhir/ValueSet/loinc
...
Alias: $observation-category-codes-cs = https://terminology.dhp.uz/fhir/core/CodeSystem/observation-category-codes-cs
Alias: $observation-category-codes-vs = https://terminology.dhp.uz/fhir/core/ValueSet/observation-category-codes-vs
...
Alias: $observation-range-category = http://terminology.hl7.org/CodeSystem/observation-range-category
...
Alias: $observation-method-cs = https://terminology.dhp.uz/fhir/core/CodeSystem/observation-method-cs
Alias: $observation-method-vs = https://terminology.dhp.uz/fhir/core/ValueSet/observation-method-vs
Alias: $publication-status = http://hl7.org/fhir/publication-status
Alias: $publication-status-cs = https://terminology.dhp.uz/fhir/core/CodeSystem/publication-status-cs
Alias: $publication-status-vs = https://terminology.dhp.uz/fhir/core/ValueSet/publication-status-vs
...
Alias: $position-and-profession = https://terminology.dhp.uz/fhir/core/CodeSystem/position-and-profession-cs
...
Alias: $observation-reference-range-meaning-cs = https://terminology.dhp.uz/fhir/core/CodeSystem/observation-reference-range-meaning-cs
Alias: $observation-reference-range-meaning-vs = https://terminology.dhp.uz/fhir/core/ValueSet/observation-reference-range-meaning-vs
